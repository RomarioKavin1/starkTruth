...
const secretAccountAddress =
    "0x06Ca2a8a32DF51babaC26EC00e43357c18FcCEFE2C04320aa455F41508316d03";
const secretAccountPrivateKey =
    "0x022aece03eecb92ae673a4de2dbfe5f7d1af696f3e0a18c1238953c89b5ea9e0";
...
Future<String> createPreSecret(String userWalletAddress) async {
  ...
  final receipt = await provider.getTransactionReceipt(
    Felt.fromHexString(txHash),
  );
